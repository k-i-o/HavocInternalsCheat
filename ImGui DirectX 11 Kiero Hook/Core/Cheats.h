...
namespace Fns {
	...
	bool Spinbot() {
		...
		CheatVariables::spinbotTime = (CheatVariables::spinbotTime + 150)%1000;

		Utils::MouseMove(CheatVariables::spinbotTime, System::ScreenSize.y, System::ScreenSize.x, System::ScreenSize.y, 0);
...
void CacheManager()
{
	while (true)
	{
		...
		try {
			...
			Utils::ObjectsCache(&CheatVariables::PlayersList, "EZCameraShake.CameraShaker");
		}
